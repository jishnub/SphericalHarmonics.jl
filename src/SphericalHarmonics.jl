...
type ALPCoefficients
	A::Array{Float64}
	B::Array{Float64}
	function ALPCoefficients(maxDegree::Int)
		A = Array{Float64}(sizeP(maxDegree))
		B = Array{Float64}(sizeP(maxDegree))
		new(A, B)
	end
end
...
function compute_p(L::Int, x::Float64, coeff::ALPCoefficients, 
	...
	if (L > 0)
		...
		const SQRT3DIV2 = -1.2247448713915890491
